...
```bash
curl -sSL https://raw.githubusercontent.com/youssefsz/reposweep/main/install.sh | bash -s -- --version v0.1.4
```

```powershell
powershell -ExecutionPolicy Bypass -c "$env:REPOSWEEP_VERSION='v0.1.4'; irm https://raw.githubusercontent.com/youssefsz/reposweep/main/install.ps1 | iex"
```
...
```bash
reposweep upgrade --version v0.1.4
```
